        ...
        <FormControl component="form">
          ...
          >
            <Table stickyHeader size="small">
              ...
              <TableBody>
                {outdtail.length > 0 ? (
                  outdtail.map((outdtails, index) => (
                    <Modal4OutItem
                      key={index}
                      no={index}
                      mcode={outdtails.masterCode}
                      pcode={outdtails.productCode}
                      pname={outdtails.productName}
                      psize={outdtails.productSize}
                      putil={outdtails.productUnit}
                      receivecnt={outdtail.receiveCount}
                      stockcnt={outdtail.stockCount}
                    />
                  ))
                ) : (
                  <TableRow>
